...
public class Product {
	public static void main(String[] args) throws Exception {
		...
		String data = "[{\"src\":\"LIGHT_SHOP\","
				+ "\"shopId\":\"2016012200077000000014429603\",\"systemType\":\"ios\","
				+ "\"x\":121.384125,\"y\":31.272242,"
				+ "\"cityId\":\"310100\"}]";
		String url = "https://mobilegw.alipay.com/mgw.htm?operationType=alipay.mobilecsa.getShopGoodsList&requestData="+URLEncoder.encode(data, "utf-8")
